  ...
  async (job) => {
    ...
    try {
      ...
      for (let i = 0; i < pendingJobs.length; i++) {
        ...
        try {
          const { fields, items, parseError, usage } = await extractDocument(
            file_path,
          ...
          try {
            ...
            const { rows: resultRows } = await client.query(
              'INSERT INTO extraction_results (extraction_job_id, ai_model, input_tokens, output_tokens, total_tokens, input_price, output_price, total_price) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id',
              [
                job_id,
                usage.model,
                usage.input_tokens,
